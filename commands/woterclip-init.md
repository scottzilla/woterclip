...
5. Scaffold `.claude/woterclip/` with config and persona templates from `${CLAUDE_PLUGIN_ROOT}/templates/`
6. Offer schedule setup
7. Print summary of what was created

If `.claude/woterclip/` already exists, ask whether to overwrite, merge, or cancel before proceeding.
